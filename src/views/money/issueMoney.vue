    ...
    <div class="all">
        ...
        <div class="detail" :model="formData">
            <div class="rows heightRows">
                ...
                <div>
                    <i v-show="errors.has('项目主题')" class="error langa flr">{{ errors.first('项目主题')}}</i>
                </div>
            </div>
            <div class="clearfix rows">
                ...
                <van-popup v-model="showArea" position="bottom" :overlay="true">
                    <van-area :area-list="areaList" @cancel="showArea = false" @confirm="onConfirm"></van-area>
                </van-popup>
            </div>
            <div class="rows heightRows">
                <span>
            ...
            <div class="clearfix rows">
                ...
                <van-popup v-model="showArea2" position="bottom" :overlay="true">
                    <van-area :area-list="areaList" @cancel="showArea2 = false" @confirm="onConfirm2"></van-area>
                </van-popup>
            </div>
            <!--  -->
            <div class="rows heightRows">
            ...
            <mu-flex align-items="center" class="radio">
                ...
                <mu-checkbox v-model="investTypes" class="itemRadio" v-for="item in investTypeList" name="type" :key="item.index" :value="item.dataValue"
                    :label="item.dataName"></mu-checkbox>
            </mu-flex>
            <div class="rows heightRows">
                <span>回报要求</span>
                <!-- v-validate="'required|repay'" name="repay" -->
                <input type="text" class="oneInput" placeholder="必须是数字" v-model="formData.minRepay">
                <!-- <div>
                    <i v-show="errors.has('repay')" class="error langa flr">{{ errors.first('repay')}}</i>
                </div> -->
            </div>
            <!--  -->
            <div class="rows heightRows">
            ...
            <div class="rows heightRows">
                <span>风控要求</span>
                <select class="oneRows" v-model="riskControls" multiple="multiple">
            ...
            <div class="rows">
                <div>其他说明</div>
                <textarea class="textarea" placeholder="" v-model="formData.otherExplain">
                </textarea>
            </div>
            <div class="rows">
        ...
        <div class="rows clearfix footers">
            ...
            <mt-button type="default" class="btns fll submit" @click="onSubmit(5)">提交</mt-button>
        </div>
    </div>
</template>
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 日期组件回调
            startSelect(val) {
                this.formData.validStartTimeStr = val
                console.log(val)
            },
            //   -----------------------
            //  展示日期组件
            ...
            // 日期组件回调
            endSelect(val) {
                this.formData.validEndTimeStr = val
                console.log(val)
            },
            // -------------------------------
                    ...
                    if (result) {
                        ...
                        this.$axios.post("/jsp/wap/center/do/doEditCapital.jsp", qs.stringify(params)).then(res => {
                            ...
                            if (res.success == "true") {
                                ...
                                let instance = Toast('上传资金失败，请完善资金信息或检查网络');
                                setTimeout(() => {
                                    instance.close();
                                }, 2000);
                            }
            ...
            onConfirm2(ele) {
                ...
                this.formData.investRegionProvinceId = ele[0].code;
                this.formData.investRegionCityId = ele[1].code;
                this.formData.investRegionCountyId = ele[2].code;
