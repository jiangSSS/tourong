            ...
            <div class="itemBox">
                <div class="" :model="formData">
                    ...
                    <div class="rows heightRows">
                        ...
                        <span>
                            <i class="red">*</i>项目名称：</span>
                        <!-- <input class="oneInput" type="text" placeholder="例:广东某企业5000万元寻互联网项目" v-model="formData.title"> -->
                        <input class="oneInput" type="text" v-validate="'required|title'" name="项目名称" placeholder="例:广东某企业5000万元寻互联网项目" v-model="formData.title">
                        <div>
                            <i v-show="errors.has('项目名称')" class="error langa flr">{{ errors.first('项目名称')}}</i>
                        </div>
                    </div>
                    <div class="rows">
                        <span>
                            <i class="red">*</i>所属行业：</span>
                        <select class="oneRows" v-model="industrys" multiple="multiple">
                    ...
                    <div class="rows">
                        <span>
                            <i class="red">*</i>所属阶段：</span>
                        <select class="oneRows" v-model="stage">
                    ...
                    <div class="rows">
                        <span>
                            <i class="red">*</i>意向资金：</span>
                        <select class="oneRows" v-model="intentCapitals" multiple="multiple">
                            <option :value="itema.dataValue" v-for="itema in intentCapitalList" :label="itema.dataName" :key="itema.dataValue" name="type">
                                {{itema.dataName}}
                            </option>
                        </select>
                    </div>
                ...
                <div>
                    ...
                    <div class="qq" v-if="formData.financeBody == 64">
                        <div class="rows">
                            <span>
                                <i class="red">*</i>企业全称：</span>
                            <input class="oneInput" type="text" v-model="formData.companyName">
                        </div>
                        <div class="clearfix rows">
                            <div class="fll divBox">
                                <i class="red">*</i>所在地区：</div>
                            <i class="iconfont icon-xiangyou flr" @click="show= true"></i>
                            <div @click="show = true">
                                <div class="areaa flr">{{province1}},{{city1}},{{county1}}</div>
                            </div>
                            <van-popup v-model="show" position="bottom" :overlay="true">
                                <van-area :area-list="areaList" @cancel="show = false" @confirm="onConfirm"></van-area>
                            </van-popup>
                        </div>
                        <div class="rows">
                            <span>
                                <i class="red">*</i>详细地址：</span>
                            <input class="oneInput" type="text" v-model="formData.address">
                        </div>
                        <div class="rows">
                            <span>
                                <i class="red">*</i>注册资本：</span>
                            <!-- <input class="oneInput" type="text" placeholder="2000万元" v-model="formData.registeredCapital"> -->
                            <span>
                                <input class="" style="width: 3.3rem;height: .6rem;" v-model="formData.registeredCapitalFormat" type="text">
                            </span>
                            <span>
                                <select v-model="formData.registeredCapitalType">
                        ...
                        <div class="rows">
                            <div style="height: .8rem;">
                                <span class="teamMember">股权结构</span>
                                <span class="addMember" @click="addSharehold">新增股东</span>
                            </div>
                            <div style="height: .8rem;" v-for="(shareholding, index) in formData.shareholdingList" :key="index">
                                <span class="langSpan">
                                    <i class="red">*</i>股东</span>
                                <input class="smallInput" type="text" v-model="shareholding.name">
                                <span>持股比例</span>
                                <input class="smallInput" type="text" v-model="shareholding.value">
                    ...
                    <div class="qq" v-else-if="formData.financeBody == 66">
                        <div class="rows">
                            <span>
                                <i class="red">*</i>单位全称：</span>
                            <input class="oneInput" type="text" v-model="formData.companyName">
                        </div>
                        <div class="clearfix rows">
                            <div class="fll divBox">
                ...
                <div class="wayBox">
                    <div v-if="fin_way == 0">
                        <div class="rows">
                            ...
                            <input class="oneInput money" type="text" v-model="formData.companyAssessed">
                            <span class="wanyuan">万元</span>
                        </div>
                        <div class="rows">
                            <span class="langmore">
                                <i class="red">*</i>市盈率(P/E)：</span>
                            <input class="oneInput lessmore" type="text" v-model="formData.pe">
                        </div>
                        <div class="rows">
                            <span class="langmore">
                                <i class="red">*</i>市净率(P/B)：</span>
                            <input class="oneInput lessmore" type="text" v-model="formData.pb">
                        </div>
                        <mu-flex align-items="center" class="radio">
                            <span class="itemRadio checkBox">
                                <i class="red">*</i>支付方式：</span>
                            <div class="checkBoxWidth">
                                <mu-checkbox v-model="paymentTypes" v-for="item in paymentTypeList" name="type" :key="item.dataValue" :value="item.dataValue"
                                    :label="item.dataName"></mu-checkbox>
                            </div>
                        </mu-flex>
                        <div class="rows">
                            <span>
                                <i class="red">*</i>有效期限：</span>
                            <span class="date-time-input" @click="getStartDate">
                                <input type="text" class="dateYear" v-model="formData.expiryDateStartTimeStr" placeholder="请选择">
                            </span>
                            <date-time ref="dateStartTime" type="date" @confirm="startSelect"></date-time>
                            <span style="margin:0 .1rem">--</span>
                            <span class="date-time-input" @click="getEndDate">
                                <input type="text" class="dateYear" v-model="formData.expiryDateEndTimeStr" placeholder="请选择">
                            </span>
                        ...
                        <div class="rows">
                            <div>保障措施：</div>
                            <textarea class="textarea" placeholder="请填写保障措施，例如业绩承诺、回购、上市承诺等" v-model="formData.safeguard"></textarea>
                        </div>
                        <div class="rows">
                            <div>交易对手简介：</div>
                            <textarea class="textarea" placeholder="" v-model="formData.opponentBrief"></textarea>
                        </div>
                    </div>
                    <div v-if="fin_way == 1">
                        <div class="rows">
                        ...
                        <div class="rows">
                            ...
                            <select class="" style="width: 4.7rem" v-model="varietys" multiple="multiple">
                                <option :value="itema.dataValue" v-for="itema in varietyList" :label="itema.dataName" :key="itema.dataValue" name="type">
                                    {{itema.dataName}}
                                </option>
                            </select>
                        </div>
                        <div class="rows">
                            <span class="">
                                <i class="red">*</i>期限：</span>
                            <input class="oneInput lessmore" type="text" v-model="formData.dueTime">
                        </div>
                        <div class="rows">
                            <span class="">
                                <i class="red">*</i>利润：</span>
                            <input class="oneInput lessmore" type="text" v-model="formData.interestRates">
                        </div>
                        <div class="rows">
                            <mu-flex align-items="center" class="radio">
                                <span class="">
                                    <i class="red">*</i>增信方式：</span>
                                <mu-checkbox v-model="creditWays" v-for="item in creditWayList" name="type" :key="item.dataValue" :value="item.dataValue"
                                    :label="item.dataName"></mu-checkbox>
                            </mu-flex>
                        </div>
                        ...
                        <div class="rows">
                            <div>
                                <i class="red">*</i>融资用途：</div>
                            <textarea class="textarea" placeholder="" v-model="formData.loanUses"></textarea>
                        </div>
                        <div class="rows">
                            <span>
                                <i class="red">*</i>还款来源：</span>
                            <input class="oneInput lessmore" type="text" v-model="formData.repaymentsSource">
                        </div>
                        <div class="rows">
                            <span>有效期限：</span>
                            <span class="date-time-input" @click="getStartDate">
                        ...
                        <div class="rows">
                            <div>
                                <i class="red">*</i>项目建设合规性：</div>
                            <textarea class="textarea" placeholder="" v-model="formData.standard"></textarea>
                        </div>
                        <div class="rows">
                            <div>
                                <i class="red">*</i>资金来源及落实情况：</div>
                            <textarea class="textarea" placeholder="" v-model="formData.sourcesFunds"></textarea>
                        </div>
                        <div class="rows">
                            <div>
                                <i class="red">*</i>项目产品及竞争能力分析：</div>
                            <textarea class="textarea" placeholder="" v-model="formData.marketCompetitivePower"></textarea>
                        </div>
                        <div class="rows">
                            <div>
                                <i class="red">*</i>项目效益测算及偿债能力分析：</div>
                            <textarea class="textarea" placeholder="" v-model="formData.guessSovency"></textarea>
                        </div>
                    </div>
                    <div v-if="fin_way == 2">
                        <div class="rows">
                            ...
                            <textarea class="textarea" placeholder="" v-model="formData.financingExplain"></textarea>
                        </div>
                    </div>
                </div>
                <div>
                ...
                <div>
                    <div class="peojectTitle">项目负责人信息</div>
                    <div class="rows heightRows">
                        <span>
                            <i class="red">*</i>姓名：</span>
                        <input class="oneInput" type="text" v-validate="'required|name'" name="姓名" v-model="formData.directorName">
                        <div>
                    ...
                    <div class="rows heightRows">
                        <span>
                            <i class="red">*</i>职务：</span>
                        <input class="oneInput" type="text" v-validate="'required|job'" name="职务" v-model="formData.directorJob">
                        <div>
                            <i v-show="errors.has('职务')" class="error langa flr">{{ errors.first('职务')}}</i>
                        </div>
                    </div>
                    <!-- <div class="rows">
                        <span>年龄：</span>
                        <input class="oneInput" type="text" v-model="formData.directorAge">
                    </div> -->
                    <div class="rows heightRows">
                        <span>
                            <i class="red">*</i>电话：</span>
                        <input class="oneInput" type="text" v-validate="'required|mobile'" name="手机号码" v-model="formData.directorPhone">
                        <div>
                ...
                <div>
                    ...
                    <div class="rows">
                        <span class="endspan">融资主体信息：</span>
                        <select class="pwdMessage" v-model="formData.bodySecrecyType">
                            <option :value="item.dataValue" v-for="item in bodySecrecyList" :key="item.dataValue" :label="item.dataName">
                                {{item.dataName}}
                            </option>
                        </select>
                    </div>
                    <div class="rows">
                        <span class="endspan">项目融资信息：</span>
                        <select class="pwdMessage" v-model="formData.infoSecrecyType">
                            <option :value="item.dataValue" v-for="item in infoSecrecyList" :key="item.dataValue" :label="item.dataName">
                                {{item.dataName}}
                            </option>
                        </select>
                    </div>
                    <div class="rows">
                        <span class="endspan">项目负责人信息：</span>
                        <select class="pwdMessage" v-model="formData.contactSecrecyType">
                            <option :value="item.dataValue" v-for="item in contactSecrecyTypeList" :key="item.dataValue" :label="item.dataName">
                                {{item.dataName}}
                            </option>
                        </select>
                    </div>
                ...
                <div class="rows clearfix footers">
                    <mt-button type="default" class="btns flr" @click="onSave">保存</mt-button>
                    <mt-button type="default" class="btns fll submit" @click="addProject(5)">提交</mt-button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 日期组件回调
            select(val) {
                this.formData.companyFoundTimeStr = val
                console.log(val)
            },
            // -----------------建企日期End---------------------
            getStartDate() {
            ...
            startSelect(val) {
                this.formData.expiryDateStartTimeStr = val
                console.log(val)
            },
            //   -----------------------
            getEndDate() {
            ...
            endSelect(val) {
                this.formData.expiryDateEndTimeStr = val
                console.log(val)
            },
            // ---------------股权融资有效日期End-----------------
            // getStartDatea() {
                    ...
                    if (result) {
                        ...
                        if (id != "") {
                            var params = {
                                ...
                                financingAmount: this.formData.financingAmount,
                                repaymentsSource: this.formData.repaymentsSource,
                        ...
                        this.$axios.post("/jsp/wap/center/do/doEditProject.jsp", qs.stringify(params)).then(res => {
                            if (res.success == "true") {
                                if (status == 0) {
                                ...
                                let instance = Toast('上传项目失败，请完善项目信息或检查登录状态');
                                setTimeout(() => {
                                    instance.close();
                                }, 2000);
                            }
            ...
            getData(id) {
                this.$axios.get(`/jsp/wap/center/ctrl/jsonProjectDetail.jsp?id=${id}`).then(res => {
                    ...
                    this.formData.expiryDateEndTimeStr = res.data.project.expiryDateEndTimeStr
                    // ---------------------------------------------------------------
                    ...
                    this.stage = res.data.project.stage
                    // if (res.data.project.stage != '') {
                    //     this.stage = res.data.project.stage.replace(/[\[\]]/g, "").split(",");
                    // }
