                    ...
                    <div class="index">
                        ...
                        <div class="detail">
                            <div class="chooseTitle">
                                <!-- <div @click="getA">综合排序</div>
                                <div @click="getB">时间排序</div> -->
                            ...
                            <!-- <div class="noData" v-show="!(this.totalCount > this.pageList.length)">--- 没有更多数据了 ---</div> -->
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            handleRemove() {
                ...
                this.getProjectList(this.financingMoneys = null, this.financingWays = null, this.industrys = null, this.regions = null)
            },
            // 确定筛选
            handleSure() {
