...
<script>
    ...
    export default {
        ...
        methods: {
            loadMore1(){
                this.pn1 += 1;
                this.$axios.get(`/jsp/wap/center/ctrl/jsonBespoketMeList.jsp`,{params:{pageNumber:this.pn1}}).then(res => {
                    this.loading = true
                    if(res.success == "true"){
            ...
            loadMore2(){
                this.pn2 += 1;
                this.$axios.get(`/jsp/wap/center/ctrl/jsonMyBespoketList.jsp`,{params:{pageNumber:this.pn2}}).then(res => {
                    this.loadings = true
                    if(res.success == "true"){
