                    ...
                    <div class="applyBox" v-for="(item,index) in pageList" :key="index">
                            ...
                            <div class="imgWarp">
                                <div class="imgBox">
                                    ...
                                    <span class="flr rightTop" @click="cancelBtn(item.id,index)">取消关注</span>
                                    <!-- <div class="applyNum">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            loadMore() {
                this.pn += 1
                this.$axios.get('/jsp/wap/center/ctrl/jsonFollowList.jsp?type=4', { params: { statuss: this.status, categorys: this.category, pageNumber: this.pn } }).then(res => {
                    this.loading = true
                    if (res.success == "true") {
            ...
            getActivityList(status, category) {
                // this.loading = true
                this.$axios.get(`/jsp/wap/center/ctrl/jsonFollowList.jsp?type=4`, { params: { statuss: this.status, categorys: this.category } }).then(res => {
